...
public final class GameRepository extends Repository<Game> {
    ...
    public List<Boolean> getPlayedGameStats(String username, PlayerRepository playerRepository) throws SQLException {
        ...
        // All finished games for this account.
        ...
        // Get all players from our finished games.
        while (resultSet.next()) {
        ...
        // Add win or loss to the list.

        return stats;
    }


    public void decideIfWon(List<Player> players) {


        // Loop over de spelers en kijk naar de hoogste score

        // Zijn wij de hoogste score?

        // Ja: Voeg toe aan de wonGames lijst.

        // Nee: Voeg toe aan de lostGames lijst.
    }
}
